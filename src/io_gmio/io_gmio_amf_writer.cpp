...
class GmioAmfWriter::Properties : public PropertyGroup {
    MAYO_DECLARE_TEXT_ID_FUNCTIONS(Bohdan::IO::GmioAmfWriter::Properties)
public:
        ...
        gmio_amf_instance* ptrInstance)
{
    ...
    if (constellationIndex == 0) {
        ...
        *ptrInstance = {};
        ...
        ptrInstance->rot.x = UnitSystem::degrees(xRotVal * Bohdan::Quantity_Radian);
        ptrInstance->rot.y = UnitSystem::degrees(yRotVal * Bohdan::Quantity_Radian);
        ptrInstance->rot.z = UnitSystem::degrees(zRotVal * Bohdan::Quantity_Radian);
    }
}
