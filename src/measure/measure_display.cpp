...
namespace {
struct MeasureDisplayI18N { MAYO_DECLARE_TEXT_ID_FUNCTIONS(Bohdan::MeasureDisplayI18N) };
} // namespace
...
std::unique_ptr<IMeasureDisplay> BaseMeasureDisplay::createEmptySum(MeasureType type)
{
    ...
    case MeasureType::MinDistance:
    case MeasureType::CenterDistance:
        return std::make_unique<MeasureDisplayDistance>(Bohdan::MeasureDistance{});
    case MeasureType::Angle:
        return std::make_unique<MeasureDisplayAngle>(Bohdan::MeasureAngle{});
    case MeasureType::Length:
        return std::make_unique<MeasureDisplayLength>(Bohdan::MeasureLength{});
    case MeasureType::Area:
        return std::make_unique<MeasureDisplayArea>(Bohdan::MeasureArea{});
    default:
        return {};
    }
}
