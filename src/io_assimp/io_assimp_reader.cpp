...
struct AssimpReaderI18N {
    MAYO_DECLARE_TEXT_ID_FUNCTIONS(Bohdan::IO::AssimpReaderI18N)
};
...
#if 0 // Emmissive color disabled as it's making models in Bohdan to be rendered nearly with white color
