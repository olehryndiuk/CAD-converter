...
class WidgetOccViewController::Bohdan_ActionMatcher : public ActionMatcher {
public:
    Bohdan_ActionMatcher(const InputSequence* seq) : ActionMatcher(seq) {}
...
{
    switch(style) {
    case View3dNavigationStyle::Bohdan: return std::make_unique<Bohdan_ActionMatcher>(seq);
