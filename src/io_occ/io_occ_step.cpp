...
class OccStepReader::Properties : public PropertyGroup {
    MAYO_DECLARE_TEXT_ID_FUNCTIONS(Bohdan::IO::OccStepReader::Properties)
public:
...
{
    BohdanIO_CafGlobalScopedLock(cafLock);
...
class OccStepWriter::Properties : public PropertyGroup {
    MAYO_DECLARE_TEXT_ID_FUNCTIONS(Bohdan::IO::OccStepWriter::Properties)
public:
    Properties(PropertyGroup* parentGroup)
        : PropertyGroup(parentGroup)
    {
